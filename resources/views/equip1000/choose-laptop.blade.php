...
<body>
    ...
    <div class="choose-laptop-container">
        <!-- left side -->
        <div class="left-side choose-side laptop-choose-side">
            <p>Get access to a laptop for your development <span>without breaking the bank.</span></p>
        </div>
        ...
        <div class="right-side">
            <div class="choose-container">
                <div class="top">
                    <div class="search">
                        <input type="search" id="searchInput" placeholder="Search for a laptop">
                        <img id="showFilter" src="../img/svg/filter.svg" alt="">
                    </div>
                    
                </div>
                <div class="back-to-mifi">
                    <a href="choose-mifi.html">Apply for a Mi-fi</a>
                ...
                <div class="fiter-container" id="filterContainer" style="display: none;">
                    ...
                    <select id="filterPrice">
                      ...
                      <option value="0-300000">Below ₦300,000</option>
                      <option value="300001-500000">₦300,000 - ₦500,000</option>
                ...
                <div class="bottom">
                    ...
                    <p class="title">Choose a Laptop</p>
                    <p class="sub-title">Choose one of the available laptops that’s also within your range of Income</p>
                </div>

                <div class="laptop-product">
                    <div class="laptop" data-brand="Dell" data-price="300001">
                        <a class="cta" href="laptop-confirmation.html">Apply Now</a>
                        <img src="../img/dell-xps-13-screen-lid1 1.png" alt="">
                        <div class="item-description">
                            <p class="detail">Dell XPS Laptop</p>
