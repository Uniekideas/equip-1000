...
<head>
    ...
    <link rel="stylesheet" href="/css/eqip/reserve/confirm.css">
...
<body>
    ...
    <div class="register-container">
        <!-- left side -->
        <div class="left-side confirm-side">
        ...
        <!-- Right side -->
        <div class="right-side confirm-mobile">
            <div class="confirm-container">
                <form id="confirmRedirect" action="#">
                    <div class="confirm-box">
                        <img class="confirm-laptop" src="../img/confirm.png" alt="">
                        <img class="confirm-mobile-icon" src="../img/svg/confirm-icon.svg" alt="">
                        <p>You have successfully registered your account, you can now move to start the process of getting empowered</p>
   ...
   <div class="mobile-bottom-nav-bar">
    <a href="verify.html" class="bar-box">
    ...
    <script src="../js/onboarding-js-code/confirm-redirect.js"></script>
