...
<head>
    ...
    <link rel="stylesheet" href="/css/eqip/reserve/verify.css">
...
<body>
    ...
    <div class="register-container">
        <!-- left side -->
        <div class="left-side verify-side">
        ...
        <!-- Right side -->
        <div class="right-side verify-mobile">
            <div class="verify-container">
                <form id="verifyForm" action="#">
                    <div class="verify-top">
                        <p class="title">Verify your email address</p>
                        <p class="sub-title">Kindly Input the 4-digit pin that was sent to your email address</p>
                    </div>
                    <div class="code">
                        <input type="text" id="digit1" name="number" maxlength="1" required>
                        <input type="text" id="digit2" name="number" maxlength="1" required>
                        <input type="text" id="digit3" name="number" maxlength="1" required>
                        <input type="text" id="digit4" name="number" maxlength="1" required>
                    </div>
                    <div class="confirm-btn">
                        <button onclick="confirmCode()">Confirm</button>
                    </div>
                    <p class="confirm-success" id="codeConfirmation"></p>
                </form>
            </div>
        </div>
   ...
   <div class="mobile-bottom-nav-bar">
    <a href="finish-register.html" class="bar-box">
    ...
    <script src="../js/confirm-code.js"></script>
    <script src="../js/refer.js"></script>
    <script src="../js/onboarding-js-code/verify-form.js"></script>
