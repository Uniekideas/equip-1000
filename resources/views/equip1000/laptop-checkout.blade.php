...
<body>
            ...
            <div class="price-summary">
                ...
                <div class="summary-items">
                    ...
                    <div class="row">
                        ...
                        <p class="row-price summary-total-price">N 300,000</p>
                    </div>
                </div>
            </div>
            <div class="choose-payment-method">
                <div class="component">
                    <select name="choosePayment" id="choosePayment" required>
   ...
   <div class="mobile-bottom-nav-bar">
    <a href="choose-laptop.html" class="bar-box">
