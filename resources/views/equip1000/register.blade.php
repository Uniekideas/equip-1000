...
<body>
    <div class="sticky">
        <div class="small-screen-navbar" style="background-color: #275c6f;">
            ...
            <ul class="nav-list" id="nav-list">
                <li><img src="../img/svg/mobile-menu-home.svg" alt=""><a href="/">Home</a></li>
            ...
            <div class="header-cta-container r-cta">
                <a class="r-log-in" href="/equip1000/home-login">Log in</a>
            </div>
        </div>
    </div>
    ...
    <div class="register-container">
        ...
        <div class="right-side">
            <div class="form-title">
                ...
                <p class="sub-title">Input your details, so we can get to know you, and serve you better</p>
            </div>
   ...
   <div class="mobile-bottom-nav-bar">
    ...
    <a href="/finish-register" class="bar-box">
    ...
    <script src="../js/onboarding-js-code/onboard-password-redirect.js"></script>
