    ...
    <div class="content">
        <div class="product-left">
            ...
            <div class="specification">
                ...
                <p class="sub-title">Get access to our Mi-fi for your seamless Internet connection and your continuous professional development</p>
            </div>
            <p class="price-label">Price</p>
            <p class="price">N20000</p>
        </div>
        
        <div class="product-details">
            <p class="title">Checkout</p>
            <p class="sub-title">This is a summary of your purchase expenses. Please select a payment method to proceed.</p>
            <div class="price-summary">
                <p class="title">Price Summary</p>
                <div class="summary-items">
                    <div class="row">
                        <p class="row-item">Item</p>
                        <p class="row-price">N 20,000</p>
                    </div>
                    <div class="row">
                        <p class="row-item">Discount</p>
                        <p class="row-price">N 0</p>
                    </div>
                    <div class="row">
                        <p class="row-item">Service charge</p>
                        <p class="row-price">N 0</p>
                    </div>
                    <div class="summary-line"></div>
                    <div class="row">
                        <p class="row-item">Total amount payable</p>
                        <p class="row-price summary-total-price">N 20,000</p>
                    </div>
                </div>
            </div>
            ...
            <a href="cash-on-delivery.html" class="confirm-btn">
    ...
    <div class="login-popup">
        ...
        <form action="">
            <div class="order-confirmation">
                ...
                <p class="confirm-text">Your Mi-fi will be delivered to you</p>
                <img class="confirm" src="../img/payment confirm.png" alt="confirm">
                </div>
