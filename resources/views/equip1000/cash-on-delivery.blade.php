...
<body>
    ...
    <div class="content">
        ...
        <div class="product-details">
            <p class="title">Cash payment on Delivery</p>
            <p class="sub-title">Please select pickup method</p>
            <div class="location-details">
                <img src="../img/svg/map-icon.svg" alt="">
                <input type="text" id="location" placeholder="Please enter your location here or use the map selector" autocomplete="street-address">
                <img class="map-pop-up" id="login" src="../img/svg/pin_drop.svg" alt="">
            </div>
            <div class="delivery-details">
                <div class="top-details">
                    <img src="../img/svg/delivery-bus.svg" alt="">
                    <p>Door delivery</p>
                </div>
                <div class="middle-details">
                    <p class="delivery-fee-title">Delivery fee</p>
                    <p class="delivery-amount">N 5,000</p>
                </div>
                <div class="bottom-details">
                    <p>Ready for delivery between 05 of march and 12 of march when you order in the next 24 hours</p>
                </div>
            </div>
            <div class="delivery-details">
                <div class="top-details">
                    <img src="../img/svg/pick-up.svg" alt="">
                    <p>Pickup Station</p>
                </div>
                <div class="middle-details">
                    <p class="delivery-fee-title">Pickup fee</p>
                    <p class="delivery-amount">N 2,000</p>
                </div>
                <div class="bottom-details">
                    <p>Arriving for pickup between 05 of match and 10 of march when you order in the next 24 hours.</p>
                </div>
            </div>
            ...
            <a href="card-details.html" class="confirm-btn">
                <p class="confirm-order">CONFIRM ORDER</p>
            </a>
        </div>
    </div>

    <!-- Start of the checkout pop up -->
    <div class="login-popup" style="background-color: transparent;">
        <!-- <form action=""> -->
            <div onclick="showConfirmation()" class="order-confirmation" style="width: 100%; margin-top: -10px; border-radius: 0;">
                <!-- <div class="cancel-btn"></div> -->
                <img class="map" src="../img/svg/Basemap image.svg" alt="">
                <div id="map"></div>
                <img id="" class="cancel-btn close-icon" style="border: none; position: absolute;top: 0; right: 0;" src="../img/svg/Ex.svg" alt="">
            </div>
        <!-- </form> -->
    </div>
   ...
   <div class="mobile-bottom-nav-bar">
    ...
    <a href="card-details.html" class="bar-box">
...
<script async defer
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCgYc6tDV-sI4hCBc1WBlOqi9G1HGkMSiA&callback=initMap">
</script>
</body>
</html>
