...
<head>
    ...
    <link rel="stylesheet" href="/css/eqip/reserve/finish-registration.css">
...
<body>
    <div class="sticky">
        <div class="small-screen-navbar" style="background-color: #275c6f;">
            ...
            <div class="header-cta-container">
                <a class="r-log-in" href="home-login.html">Log in</a>
          </div>
        </div>
    ...
    <div class="register-container">
        <!-- left side -->
        <div class="left-side finish-side">
            <p>Join the empowerment train, and be equipped by <span>EQUIP1000</span> Project</p>
            <div class="refer">
        ...
        <!-- Right side -->
        <div class="right-side right-finish">
            <!-- <div class="login">
                <a href="">Log In</a>
            </div> -->
            <div class="form-title">
                <p class="title">Register</p>
                <p class="sub-title">Finish your account setup by setting your password</p>
            </div>
            <div class="reg-form-container finish-container" style="width: 100%;">
                <form id="finishReg" onsubmit="return validatePassword()" action="#" style="width: 100%;">
                    <p id="passwordCheck"></p>
                    <div class="col-1 f-col-1" style="width: 87%;">
                        <label for="pwd">Password</label>
                        <div class="password-container">
                            <input type="password" id="pwd" name="c-pwd" style="width: 100%;" placeholder="Enter password" required>
                        ...
                        <div class="password-container">
                            <input type="password" id="c-pwd" name="c-pwd" style="width: 100%;" placeholder="Enter password" required>
                            <span class="password-toggle" onclick="togglePasswordVisibility('c-pwd')"><img src="../img/svg/visible-eye.svg" alt=""></span>
                        </div>
   ...
   <div class="mobile-bottom-nav-bar">
    ...
    <script src="../js/onboarding-js-code/finish-reg.js"></script>
